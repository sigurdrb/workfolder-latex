...
\scriptsize 
    ...
    \item<3-> It then moves through the liftup-unit by means of gravity and a VSD controlled conveyor belt
    \item<4-> Flushing system
    \item<5-> Camera unit / vision system
    \item<6-> Stunner unit (state mandatory)
...
\begin{minipage}[t]{0.5\textwidth}
    ...
    \includegraphics<2>[width=0.7\textwidth]{airliftpump.png}
    %
    \includegraphics<2>[width=0.5\textwidth]{liftup1.jpg}
    \includegraphics<3-4>[width=0.8\textwidth]{liftup2.jpg}
...
\begin{frame}
\frametitle{Scenarios}
\onslide<4->{\includegraphics[width=\textwidth]{snip1.png}} \newline
\framebox{\parbox{\dimexpr\linewidth-2\fboxsep-2\fboxrule}{
